...
大语言模型本质上就是个文字接龙游戏，比如我们提问”浙江的省会是哪里“，大模型收到这句话、经过一堆运算、会预测下一个概率最高的词、输出”美丽的“，此时大模型并不会停下来，而是会把我们的提问和它的输出组合成一个新的输入——”问题：浙江的省会是哪里；答案：美丽的“，再去预测下一个概率最高的词、输出”杭州“，此时大模型发现不需要再往下继续预测了，于是回答”美丽的杭州“。
